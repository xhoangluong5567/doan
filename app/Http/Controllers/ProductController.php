...
class ProductController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $products = DB::table('products')->where('p_name', 'like', '%' . $search . '%')->paginate(5);
        return view('backend.products.index', ['products' => $products]);
    }
    ...
    public function showhang($id)
    {
        ...
        return view('frontend.details', array('product' => $product, 'categories' => $categories, 'product_images' => $product_images));
    }
