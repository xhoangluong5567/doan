...
<div class="container">
		...
		<form>
			<table class="table table-bordered .table-responsive text-center">
				...
				<tr>
					...
					<td><span class="prices">{{number_format($product->price*$product->qty)}} VND</span></td>
			...
			<div class="row" id="total-price">
				...
				<a href="{{route('get.form.pay')}}">Thanh Toan</a> 
				<div class="col-md-6 col-sm-12 col-xs-12">
	...
	<h3 style="text-algin: center;">Giỏ Hàng Trống</h3>
	@endif
